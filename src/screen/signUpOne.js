  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Text style={{marginRight:"57%", color:"white", marginTop:15}}>FIRST NAME</Text>
        ...
        <TextInput
          ...
          />
          <Text style={{marginRight:"57%", color:"white", marginTop:15}}>LAST NAME</Text>
          ...
          <TouchableOpacity style={{marginLeft:"75%"}} onPress={this.goToSignUpTwo}>
